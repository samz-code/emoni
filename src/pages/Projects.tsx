...
export default function Projects() {
  ...
  // Map projects rows (snake_case columns) into the shape ProjectCard expects.
  // Mirrors the same pattern used for designProjects below — keeps the
  // Supabase column names (live_url, created_at, etc.) contained to this
  // fetch layer instead of leaking into components.
  ...
  // Fetch Graphic Design items from their own table (NOT the projects table)
  ...
  // Map graphic_designs rows (title/category) into the shape ProjectCard expects (name/sector)
