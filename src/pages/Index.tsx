...
const stats = [
  ...
  { number: "6+", label: "Years Design" },
  { number: "5+", label: "Years Dev" },
];
...
const Index = () => {
  return (
    <main>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <motion.div {...fadeIn} className="lg:col-span-7">
              ...
              <h1 className="font-display text-4xl md:text-[56px] text-ink leading-tight max-w-xl">
              ...
              <p className="font-body text-lg text-[#4A4A4A] max-w-lg mt-4 leading-relaxed">
                I partner with businesses and government institutions to design, develop, and improve digital systems that work — reliably, securely, and at scale. 1000+ projects delivered across East Africa.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mt-6">
                {[
                  ...
                  <span key={badge.text} className="flex items-center gap-1.5 text-xs font-body text-olive">
                    <badge.icon size={14} />
                    {badge.text}
                  </span>
                ))}
            ...
            >
              <div className="bg-snow border border-[#E0DAD0] rounded-[4px] p-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  {stats.map((stat) => (
                    <div key={stat.label}>
                      <p className="font-display text-[28px] text-forest">{stat.number}</p>
                      <p className="font-body text-[11px] text-[#9A9A9A]">{stat.label}</p>
                    </div>
                  ))}
                </div>
      ...
      {/* Services Preview */}
      <section className="bg-paper py-24 border-t border-[#E0DAD0]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {services.slice(0, 8).map((service) => {
              ...
              return (
                <Link
                  ...
                  className="bg-snow border border-[#E0DAD0] rounded-[4px] p-5 hover:border-olive transition-colors block"
                >
                  <Icon size={22} className="text-olive" />
                  <h3 className="font-display text-[18px] text-ink mt-3 leading-snug">
                    {service.name}
                  </h3>
            ...
            <div className="lg:col-span-7 space-y-4">
              {[
                ...
                >
                  ...
                  <div>
                    <h3 className="font-display text-[20px] text-ink leading-snug">
                      {item.t}
                    </h3>
